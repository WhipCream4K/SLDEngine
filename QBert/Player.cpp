...
Player::Player(SLD::WorldEntity& world)
{
	...
	m_TransformComponent->SetScale(2.5f, 2.5f,1.0f);
	...
	m_RenderingComponent->PushElement(SLD::RenderIdentifier(SFMLRenderElement::WorldMatrix),&m_TransformComponent->GetWorldFinishMatrix());
