...
public:
	...
	std::vector<JoyStickEvent> GetGamepadState();
};

std::vector<SLD::JoyStickEvent> SLD::Window::ImplXInput::GetGamepadState()
{
	std::vector<SLD::JoyStickEvent> outState{};
